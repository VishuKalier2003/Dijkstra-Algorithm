// Assessment 5...
/*Design Graph Algorithm Dijkstra's Algorithm and Bellman Ford Algorithm on the Graphs from the source
vertex to all other vertices in the Graphs...*/
#include<iostream>
#include<vector>
#include<set>
using namespace std;
typedef pair<int,unsigned long long> PII;  // Pairing component
